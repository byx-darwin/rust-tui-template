...
- [TUI Patterns](./tui-patterns.md) — terminal lifecycle, event loop, rendering, input handling, and testing.
- [Monitoring Panel](./monitoring-panel.md) — the bundled system monitoring demo app.
